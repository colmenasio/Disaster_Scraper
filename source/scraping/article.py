...
class Article:
    ...
    def answer_severity_scale_question(self, question: str) -> float | None:
        ...
        sys_prompt = ("Eres una herramienta de extraccion de datos.\n"
                      ...
                      "afectado el sector descrito en la pregunta. Para ello ten en cuenta factores como "
                      "la duracion de la afeccion, el coste económico, el impacto a infraestructura critica, etc.\n"
